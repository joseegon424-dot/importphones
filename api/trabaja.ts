      ...
      html: `
        <div style="font-family: sans-serif; max-width: 600px; margin: auto; border: 1px solid #eaeaea; border-radius: 8px; padding: 20px;">
          ...
          <div style="margin-top: 20px;">
            <p><strong>📎 Curriculum Vitae Adjunto:</strong></p>
            <a href="${fileUrl}" style="display: inline-block; background: #E53935; color: white; text-decoration: none; padding: 10px 20px; border-radius: 5px; font-weight: bold;">Ver / Descargar CV</a>
            <p style="font-size: 0.8em; color: #888; margin-top: 10px;">Enlace seguro a Supabase Storage.</p>
          </div>
          ` : '<p style="color:red">No se adjuntó Curriculum.</p>'}
        </div>
      `,
    });
